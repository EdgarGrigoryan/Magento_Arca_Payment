 ...
 */
class Studioone_ArCa_Helper_Hss extends Mage_Core_Helper_Abstract
{
    /**
    ...
    protected $_hssMethods = array(
        Studioone_ArCa_Model_Config::METHOD_HOSTEDPRO,
        Studioone_ArCa_Model_Config::METHOD_PAYFLOWLINK,
        Studioone_ArCa_Model_Config::METHOD_PAYFLOWADVANCED
    );
