...
class Studioone_ArCa_ProcessingController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _expireAjax()
    {
	 ...
	 public function resultAction()
	 {
		 ...
		 $url = "https://www.arca.am:8194/ssljson.yaws"; // Merchant should use the URL provided by ArCa!!!
    	 $url_test = "https://91.199.226.106/ssljson.php"; // Merchant should use the URL provided by ArCa!!!
